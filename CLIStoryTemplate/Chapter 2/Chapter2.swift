...
//func chapterTwo(){
    ...
    print("\(name) laboratory, nestled in a remote corner of the New Mexico desert, was filled with strange contraptions and untested inventions. He was on the verge of a discovery that could change humanity's understanding of the cosmos and the affect the chemtrails had on /(firstplace), but he could never have anticipated the extraordinary turn his life would take one fateful night. It was a clear, starry evening when \(name) set up his latest experiment. He was testing a new device designed to harness energy from distant celestial bodies, a feat that would revolutionize the universe quality of air that could possibly be the solution to the crops regaing natural resources to maintain growth and fertility. As he adjusted the controls, a blinding burst of light engulfed the laboratory. Stunned, he found himself floating in the air, surrounded by a swirling vortex of energy. Disorientation was palpable as he realized he was no longer on earth. He was aboard an otherworldly spacecraft, surrounded by beings that were both fascinating and terrifying. They were tall, slender, with elongated limbs and irridescent skin. Their eyes held a profound wisdom, and they communicated with him through a form of telepathy. ")
